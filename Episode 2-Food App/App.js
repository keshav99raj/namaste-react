...
/* 
-Header=logo,navbar
-body=search,restaurentcontainer->restaurent card,
restuarent card->img,name of res,star rating,cuisine delivery time,
...
const Header = () => {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?nwm=1&nws=1&industry=food&sf=&txt_keyword=All" />
      </div>
